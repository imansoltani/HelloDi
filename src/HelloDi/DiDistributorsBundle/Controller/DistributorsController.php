...
$tickets=$em->getRepository('HelloDiDiDistributorsBundle:Ticket')->findBy(array('Account'=>$Account));
   ...
   $form->submit($req);
    ...
    $tickets=$em->createQueryBuilder();
     $tickets->select('Tic')
         ...
         ->andWhere('Tic.Account = :Acc')->setParameter('Acc',$Account);
    if($data['Type']!=5)
